...
<template>
	...
	<div v-if="state.createListMovies === true">
		<h2>Film</h2>
		<ul v-for="(movie, index) in  state.movies ">
			<img :src="state.url_Image + movie.poster_path" alt="" @mouseover="showOnInfoCard(index)"
				@mouseleave="showOff(index)">
			...
			<div v-if="showInfo === true">
				...
				<li v-if="movie.original_language === 'en'">Lingua: <img class="w_flag" src="../assets/img/flag/gb.svg"
						alt=""></li>
				<li v-else-if="movie.original_language === 'it'">Lingua: <img class="w_flag"
						src="../assets/img/flag/it.svg" alt=""></li>
				<li v-else-if="movie.original_language === 'es'">Lingua: <img class="w_flag"
						src="../assets/img/flag/es.svg" alt=""></li>
				<li v-else-if="movie.original_language === 'fr'">Lingua: <img class="w_flag"
						src="../assets/img/flag/fr.svg" alt=""></li>
				<li v-else-if="movie.original_language === 'ja'">Lingua: <img class="w_flag"
						src="../assets/img/flag/jp.svg" alt=""></li>
